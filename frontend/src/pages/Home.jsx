  ...
  return (
    <>
      ...
      <div className="flex items-center px-[100px] justify-between mt-5">
        <h3 className='text-2xl'>👋 Hi, {name || 'there'}</h3>
      ...
      <div className="projects px-[100px] mt-5 pb-10">

        {
          projects && projects.length > 0 ? projects.map((project, index) => {
            return <div key={project._id || index} className="project w-full p-[15px] flex items-center justify-between bg-[#0f0e0e]">
                      ...
                      <>
                        ...
                        <>
                          ...
                          <>
                            ...
                            <>
                              <img className='w-[130px] h-[100px] object-cover' src="https://cdn.jsdelivr.net/gh/devicons/devicon/icons/java/java-original.svg" alt="Java" />
